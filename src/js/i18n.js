...
const i18n = {
    ja: {
        ...
        loadingBaseModels: 'Base Models を読み込んでいます...',
        baseModelHelp: '利用可能な Base Model が API から自動的に取得されます',
    ...
    en: {
        ...
        loadingBaseModels: 'Loading Base Models...',
        baseModelHelp: 'Available Base Models will be automatically fetched from the API',
